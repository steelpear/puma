...
export const PhoneNumberInfo = () => {
  ...
  return (
    <div className="card flex justify-content-center">
      <Button className='ml-2' icon="pi pi-mobile" rounded text severity="info" size='large' aria-label="Region" onClick={(e) => op.current.toggle(e)} tooltip="Информация о номере" tooltipOptions={{ position: 'right' }} />
